...
import static com.example.watersystem.map.utils.MapUtil.convertToLatLng;
import static com.example.watersystem.map.utils.MapUtil.convertToLatLonPoint;
...
import com.example.watersystem.map.overlay.BusRouteOverlay;
import com.example.watersystem.map.overlay.DrivingRouteOverlay;
import com.example.watersystem.map.overlay.RideRouteOverlay;
import com.example.watersystem.map.overlay.WalkRouteOverlay;
import com.example.watersystem.map.utils.MapUtil;

import java.util.List;

public class RouteFragment extends Fragment implements
        AMapLocationListener, RouteSearch.OnRouteSearchListener, EditText.OnKeyListener,
     ...
     * 初始化出行方式
     */
    private void initTravelMode(View view) {
        ...
        etStartAddress = view.findViewById(R.id.et_start_address);

        etEndAddress = view.findViewById(R.id.et_end_address);
        //键盘按键监听
        etStartAddress.setOnKeyListener(this);
        etEndAddress.setOnKeyListener(this);

        //将可选内容与ArrayAdapter连接起来
        arrayAdapter = new ArrayAdapter<>(getContext(), android.R.layout.simple_spinner_item, travelModeArray);
        //设置下拉列表的风格
     ...
     * 初始化路线
     */
    private void initRoute(View view) {
        try {
                ...
                if (busRouteResult.getPaths().size() > 0) {
                    ...
                    bottomLayout.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            bundle.putParcelable("path", busPath);

                            RouteDetailFragment fragment = new RouteDetailFragment();
                            fragment.setArguments(bundle);
                            NavHostFragment.findNavController(RouteFragment.this).navigate(R.id.routeDetailFragment);
                        }
                    });
                ...
                if (driveRouteResult.getPaths().size() > 0) {
                    ...
                    bottomLayout.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            bundle.putParcelable("path", drivePath);
                ...
                if (walkRouteResult.getPaths().size() > 0) {
                    ...
                    bottomLayout.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            bundle.putParcelable("path", walkPath);
                ...
                if (rideRouteResult.getPaths().size() > 0) {
                    ...
                    bottomLayout.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            bundle.putParcelable("path", ridePath);
