...
public class MapFragment extends Fragment implements
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        floatingActionButton = view.findViewById(R.id.fab_route);

        fabPOI = view.findViewById(R.id.fab_poi);
        fabClearMarker = view.findViewById(R.id.fab_clear_marker);
    ...
    public void onDestroy() {
        ...
        //执行onDestroy时执行mMapView.onDestroy()，销毁地图
        if (mapView != null) {
            mapView.onDestroy();
        }
    }
    ...
    public void onResume() {
        super.onResume();
        //执行onResume时执行mMapView.onResume ()，重新绘制加载地图
        if (mapView != null) {
            mapView.onResume();
        }
    }
    ...
    public void onPause() {
        super.onPause();
        //执行onPause时执行mMapView.onPause ()，暂停地图的绘制
        if (mapView != null) {
            mapView.onPause();
    ...
    public void onPoiSearched(PoiResult poiResult, int i) {
        ...
        for (PoiItem poiItem : poiItems) {
            Log.d(TAG, " Title：" + poiItem.getTitle() + " Snippet：" + poiItem.getSnippet());
        }
    }
    ...
    private void render(Marker marker, View view) {
        ((ImageView) view.findViewById(R.id.badge))
                .setImageResource(R.drawable.map_icon_yuan);
     ...
     * 进入路线规划
     */
    public void jumpToRouteFragment() {

        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavHostFragment.findNavController(MapFragment.this).navigate(R.id.routeDetailFragment);
            }
        });
    }
}